...
import AccesstradeVoucher from "@/components/coupons/AccesstradeVoucher";

export default function CouponsPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-10 text-center">
        <h1 className="text-3xl font-black text-gray-800 uppercase">Kho Voucher Shopee</h1>
        <p className="text-gray-500">Mã giảm giá được cập nhật tự động từ hệ thống</p>
      </div>

      {/* Widget của chúng ta */}
      <AccesstradeVoucher />
      
      {/* Bạn có thể giữ lại phần Card cũ ở dưới nếu muốn hiển thị song song */}
    </div>
  );
}